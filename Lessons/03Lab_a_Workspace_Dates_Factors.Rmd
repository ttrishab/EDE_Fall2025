...
#Create and print a list of all files that start with the letter "N"
# in the Data/Raw folder using "dir" and "here"
filenames <- dir(here('Data','Raw'),pattern = ("^N.*csv"))
print(filenames)
```
...
2.    Refer to the example code shown here (https://people.duke.edu/~jpfay/ENV872/here.html) to read in all CSV files starting with "EPAair_O3" into a single dataframe. 
...
#Alternative 1
date_obj_past <- fast_strptime(str_past,"%y-%b-%d",cutoff_2000=25L)
date_obj_past

#Alternative 2
date_obj_past2 <- parse_date_time2(str_past,"ymd",cutoff_2000=25L)
date_obj_past2
