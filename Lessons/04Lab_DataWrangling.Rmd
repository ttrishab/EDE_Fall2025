...
NTL.phys.data.Tuesday90.99 <- filter(NTL.phys.data, lakename == "Tuesday Lake" & year4 >= 1990 & year4 <= 1999)
...
NTL.phys.irradiance.gathered <- pivot_longer(NTL.phys.data, irradianceWater:irradianceDeck, names_to = "Irradiance_Type",values_to = "Irradiance_Value")

#Exercise 6: Spread temperatureC into more than one column based on the depth.
NTL.phys.irradiance.spread <- pivot_wider(NTL.phys.data, names_from = "depth", values_from = "temperature_C")
