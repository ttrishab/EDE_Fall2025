...
-   **Simple feature**: one row in the sf collection (row)
-   **Simple feature column (sfc)**: the column containing geometries (column)
-   **Simple feature geometry (sfg)**: a single geometric object (spatial point)
...
mapview(EPAair.sf,cex = "mean_PM25")
```
